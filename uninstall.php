...
delete_option('product_info_sync');
delete_option('sincronizar_precio');
delete_option('productos_categorias_sincronizar');
...
delete_site_option('product_info_sync');
delete_site_option('sincronizar_precio');
delete_site_option('productos_categorias_sincronizar');
