...
$wpdb->query($wpdb->prepare("DELETE FROM ".$wpdb->prefix."postmeta WHERE meta_key=%s OR meta_key=%s OR meta_key=%s",'order_obuma_rut','order_obuma_tipo_documento','order_obuma_giro_comercial'));
